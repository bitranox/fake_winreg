...
def set_minimal_windows_testvalues(_fake_registry: Optional[FakeRegistry] = None) -> FakeRegistry:
    """
    ...
    # Current Build
    set_fake_reg_value(_fake_registry.hive[HKEY_LOCAL_MACHINE], r'SOFTWARE\Microsoft\Windows NT\CurrentVersion', 'CurrentBuild', '18363')

    # Profile List in Windows10
    set_fake_reg_value(_fake_registry.hive[HKEY_LOCAL_MACHINE], r'SOFTWARE\Microsoft\Windows NT\CurrentVersion\ProfileList\S-1-5-18',
                       'ProfileImagePath', r'%systemroot%\system32\config\systemprofile', REG_EXPAND_SZ)
    set_fake_reg_value(_fake_registry.hive[HKEY_LOCAL_MACHINE], r'SOFTWARE\Microsoft\Windows NT\CurrentVersion\ProfileList\S-1-5-19',
                       'ProfileImagePath', r'%systemroot%\ServiceProfiles\LocalService', REG_EXPAND_SZ)
    set_fake_reg_value(_fake_registry.hive[HKEY_LOCAL_MACHINE], r'SOFTWARE\Microsoft\Windows NT\CurrentVersion\ProfileList\S-1-5-20',
                       'ProfileImagePath', r'%systemroot%\ServiceProfiles\NetworkService', REG_EXPAND_SZ)
    set_fake_reg_value(_fake_registry.hive[HKEY_LOCAL_MACHINE],
    ...
    set_fake_reg_key(_fake_registry.hive[HKEY_USERS], '.DEFAULT')
    set_fake_reg_key(_fake_registry.hive[HKEY_USERS], 'S-1-5-18')
    set_fake_reg_key(_fake_registry.hive[HKEY_USERS], 'S-1-5-19')
    set_fake_reg_key(_fake_registry.hive[HKEY_USERS], 'S-1-5-20')
    set_fake_reg_key(_fake_registry.hive[HKEY_USERS], 'S-1-5-21-206651429-2786145735-121611483-1001')
    set_fake_reg_key(_fake_registry.hive[HKEY_USERS], 'S-1-5-21-206651429-2786145735-121611483-1001_Classes')
    set_fake_reg_value(_fake_registry.hive[HKEY_USERS], r'S-1-5-21-206651429-2786145735-121611483-1001\Volatile Environment', 'USERNAME', 'bitranox', REG_SZ)
